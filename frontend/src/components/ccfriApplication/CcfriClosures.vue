                  ...
                  <v-card v-for="(obj, index) in CCFRIFacilityModel.dates" :key="obj.id" class="px-6 py-4 pl-md-0 mb-8">
                    <v-row no-gutters class="align-center">
                      ...
                      <v-col cols="12" md="11">
                        ...
                        <v-row no-gutters>
                          <div class="span-label font-regular pt-2 pr-4">Is this a full facility closure?</div>
                          <v-radio-group
                        ...
                        <template v-if="obj.isFullFacilityClosure">
                          <div class="span-label font-regular pt-2 pr-4 mb-2">
