      ...
      <v-row justify="space-around">
        <v-card class="cc-top-level-card" width="1200">
          <v-container>
            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field outlined required v-model="yearBeginOperation" type="number" :rules="rules.required" label="Year Facility Began operation (YYYY)" />
              </v-col>
              <v-col cols="12" md="6">
            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field outlined required type="number" v-model="licenseNumber" :rules="rules.required" label="Facility Licence Number" />
              </v-col>
              <v-col cols="12" md="6">
