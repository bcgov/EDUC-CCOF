      ...
      <v-row justify="space-around">
        <v-card class="cc-top-level-card" width="1200">
          <v-container>
            <v-row>
              <v-col>
                <v-text-field outlined required v-model="facilityNameCommunityCare" :rules="rules.required"
            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field outlined required v-model="yearBeginOperation" type="number" :rules="rules.required"
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-text-field outlined required v-model="postalCode" :rules="[...rules.required, ...rules.postalCode]"
                  label="Postal Code" />
              </v-col>
            </v-row>
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-text-field outlined required v-model="email" :rules="[...rules.required, ...rules.email]"
            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field outlined required type="number" v-model="licenseNumber" :rules="rules.required"
              ...
              <v-col cols="12" md="6">
                <v-menu v-model="calendarMenu" :close-on-content-click="false" :nudge-right="40"
                  ...
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field outlined required v-model="licenseEffectiveDate"
                      label="Effective Date of Current Licence (YYYY-MM-DD)" readonly v-bind="attrs" v-on="on">
                    </v-text-field>
                  </template>
            ...
            <v-row v-show="hasReceivedFunding === 'yesFacility'">
              <v-col>
                <v-text-field outlined required v-model="facilityName"
                  :rules="hasReceivedFunding === 'yesFacility' ? rules.required : []" label="Facility Name" />
              </v-col>
            </v-row>
