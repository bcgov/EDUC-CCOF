    ...
    <v-card elevation="6" class="mt-12 rounded-lg">
      ...
      <div class="px-8 py-4">
        <p v-if="languageYearLabel == programYearTypes.HISTORICAL">
          Do you charge parent fees at this facility for any closures on business days (other than designated holidays)?
        ...
        <v-radio-group v-model="CCFRIFacilityModel.hasClosureFees" :disabled="isReadOnly" :rules="rules.required">
          <br />
