<template>
  <v-container>
    ...
    <v-row justify="space-around">
      ...
      <v-btn color="secondary" :disabled="!this.enabledButtons" outlined x-large @click="next()">Next</v-btn>
      <v-btn color="primary" :disabled="!this.enabledButtons" outlined x-large @click="saveFacilities()">Save</v-btn>
    </v-row>
  </v-container>
</template>
...
export default {
  ...
  methods: {
    ...
    toggleRadio(index) {
      ...
      if (this.facilities[index].optInOrOut == 1) {
        this.enabledButtons = true;
      }
