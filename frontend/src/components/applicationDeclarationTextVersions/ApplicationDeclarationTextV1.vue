  ...
  <template v-else-if="isDeclarationBDisplayed">
    ...
    <ol class="declarationBList" type="a">
      ...
      <li>
        ...
        the Provider in any or all of the Child Care Operating Funding Program, the CCFRI, or the ECE Wage Enhancement;
      </li>
      <li>
        ...
        providing false or misleading information either on the Form or otherwise to the Province to obtain any funding
...
export default {
  name: 'ApplicationDeclarationTextV1',
  props: {
    enabledDeclarationB: {
      type: Boolean,
      default: false,
