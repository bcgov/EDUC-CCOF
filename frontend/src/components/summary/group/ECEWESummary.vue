    ...
    <v-form ref="eceweSummaryForm" v-model="isValidForm">
      <v-expansion-panel-header>
        <h4 style="color: #003466">
          ...
          <span v-if="!isValidForm && !this.isProcessing" style="color: #ff5252"
              ...
              <v-row no-gutters class="d-flex justify-start">
                <v-col cols="12" class="d-flex justify-start">
                  <span class="summary-label pt-2"
                    >For the {{ this.formattedProgramYear }} funding term, would you like to opt-in to ECE-WE for any
                    facility in your organization</span
                  >
                  <v-text-field
                    placeholder="Required"
                    :value="this.getYesNoValue(ecewe?.optInECEWE)"
                    class="summary-value"
                    dense
                    flat
                    solo
            ...
            <v-col v-if="ecewe?.optInECEWE == 1" cols="12" lg="6" class="pb-0 pt-0">
              <v-row no-gutters class="d-flex justify-start">
                <v-col cols="12" class="d-flex justify-start">
                  ...
                  <v-text-field
                    placeholder="Required"
                    :value="this.getYesNoValue(ecewe?.belongsToUnion)"
                    class="summary-value"
                    dense
                    flat
                    solo
              ...
              <v-col v-if="ecewe?.optInECEWE == 1" cols="12" lg="6" class="pb-0 pt-0">
                <v-row no-gutters class="d-flex justify-start">
                  <v-col cols="12" class="d-flex justify-start">
                    ...
                    <v-text-field
                      placeholder="Required"
                      :value="this.getYesNoValue(ecewe?.publicSector)"
                      class="summary-value"
                      dense
                      flat
                      solo
            ...
            >
              <v-row no-gutters class="d-flex justify-start">
                <v-col cols="12" class="d-flex justify-start">
                  ...
                  <v-textarea
                    placeholder="Required"
                    :value="this.getSectorValue(ecewe?.applicableSector)"
                    class="summary-value"
                    dense
                    flat
                    solo
            ...
            >
              <v-row no-gutters class="d-flex justify-start">
                <v-col cols="12" class="d-flex justify-start">
                  ...
                  <v-textarea
                    placeholder="Required"
                    :value="this.getFundingModel(ecewe?.fundingModel)"
                    class="summary-value"
                    dense
                    flat
                    solo
              ...
              >
                <v-col cols="12" class="d-flex justify-start">
                  ...
                  <v-text-field
                    placeholder="Required"
                    :value="this.getYesNoValue(ecewe?.confirmation)"
                    class="summary-value"
                    dense
                    flat
                    solo
