          ...
          <v-col cols="4" lg="4" class="pb-0 pt-0">
            <v-row no-gutters class="d-flex justify-start">
              ...
              <v-col cols="12" class="d-flex justify-end">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.extendedChildCareUnder36Months4OrLess" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
              <v-col cols="12" class="d-flex">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.extendedChildCare36MonthsToSchoolAge4OrLess" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
              <v-col cols="12" class="d-flex justify-center">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.extendedChildCareSchoolAge4OrLess" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
              <v-col cols="12" class="d-flex justify-center">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.multiAgeCare4OrLess" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
            </v-row>
          </v-col>
          <v-col cols="4" lg="4" class="pb-0 pt-0">
            <v-row no-gutters class="d-flex justify-start">
              ...
              <v-col cols="12" class="d-flex justify-center">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.extendedChildCareUnder36Months4OrMore" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
              <v-col cols="12" class="d-flex justify-center">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.extendedChildCare36MonthsToSchoolAge4OrMore" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
              <v-col cols="12" class="d-flex justify-center">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.extendedChildCareSchoolAge4OrMore" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
              <v-col cols="12" class="d-flex justify-center">
                <v-text-field placeholder="Required" :rules="rules.required" :value="this.funding?.multiAgeCare4more" class="summary-value" dense flat solo hide-details readonly></v-text-field>
              </v-col>
            </v-row>
          </v-col>
        </v-row>
