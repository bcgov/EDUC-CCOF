        ...
        >
          <v-container fluid class="px-6">
            <template v-if="showDeclarationA">
              <p>
                this is two I hereby confirm that the information I have provided in this application is complete and
            ...
            <template v-else-if="showDeclarationB">
              ...
              <p>
                By completing and submitting this form electronically, I hereby confirm that I have carefully read this
                form and the corresponding terms and conditions of the Child Care Operating Funding Agreement (the
                Funding Agreement) and that I agree to be bound by such terms and conditions. I further confirm that by
                clicking “I agree, consent, and certify” below, I represent and warrant that:
              </p>
              ...
              <ol class="declarationBList" type="a">
                ...
                <li>
                  I have authority to submit this form on behalf of the Provider and that by clicking “I agree, consent,
                  and certify”, I do hereby bind the Provider to the terms and conditions of the Funding Agreement if
                  the Province accepts this form and enrols the Provider in any or all of the Child Care Operating
                  Funding Program, the Child Care Fee Reduction Initiative, or the ECE Wage Enhancement;
                </li>
                <li>
                  All information provided on this form or otherwise in support of the Provider to receive funding under
              ...
              <p style="padding-top: 10px">
                ...
                approval of enrolment, in writing, in the Child Care Fee Reduction Initiative or the ECE Wage
                Enhancement, the Provider is not formally enrolled in these initiatives. The Province is not responsible
                for any pre-payments the Provider may make in anticipation of enrolment in either of these initiatives
                and any pre-payments made are at the Provider's own risk.
              </p>
            </template>
...
export default {
  ...
  computed: {
    ...
    allFacilitiesApproved() {
      return this.facilities?.every((facility) => facility.facilityInfo.facilityAccountNumber);
    },
  ...
  methods: {
    ...
    async loadData() {
      try {
        ...
        // check about this chunk of code??? -PANIKA
