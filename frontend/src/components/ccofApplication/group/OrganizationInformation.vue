          ...
          <v-card class="cc-top-level-card" width="1200">
            <v-container>
              ...
              <v-row>
                ...
                <v-col cols="12" md="6">
                  <v-text-field :disabled="isLocked" outlined required :rules="rules.required" v-model="model.incNumber" type="number" label="Incorporation Number (as it appears in BC Corporate Registry)" />
                </v-col>
              </v-row>
