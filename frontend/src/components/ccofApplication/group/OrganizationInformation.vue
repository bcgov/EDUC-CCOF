      ...
      <v-row justify="space-around">
        <v-card class="cc-top-level-card" width="1200">
          <v-container>
            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field outlined required v-model="model.contactName" :rules="rules.required" label="Organization Contact Name" />
              </v-col>
              <v-col cols="12" md="6">
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-text-field outlined required :rules="rules.required" v-model="model.incNumber" type="number" label="Incorporation Number (as it appears in BC Corporate Registry)" />
              </v-col>
            </v-row>
