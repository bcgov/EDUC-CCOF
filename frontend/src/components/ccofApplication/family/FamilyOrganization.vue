      ...
      <v-row justify="space-around">
        <v-card class="cc-top-level-card" width="1200">
          ...
          <v-container>
            ...
            <v-row>
              <v-col>
                <v-text-field :disabled="isLocked" outlined required v-model="model.providerName"
            ...
            <v-card-subtitle> Organization Street Address, if different from the Mailing Address (Optional)
            </v-card-subtitle>
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-text-field :disabled="isLocked" outlined v-model="model.postalCode2" :rules="rules.postalCode"
                  label="Postal Code" />
              </v-col>
            </v-row>
