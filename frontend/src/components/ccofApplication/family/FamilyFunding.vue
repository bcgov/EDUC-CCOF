      ...
      <v-row justify="space-around">
          ...
          <v-container>
            <v-row>
              <v-col>
                ...
                <v-radio-group :disabled="isLocked" required :rules="rules.required" v-model="model.familyLicenseType"
                  label="License type" v-show="!loading">
        ...
        <v-card class="cc-top-level-card" width="1200">
          <v-container>
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field :disabled="isLocked" type="number" min="0" :max="model.maxLicensesCapacity" outlined
                  required :rules="[...rules.required, rules.min(0), rules.max(model.maxLicensesCapacity)]"
                  v-model.number="model.maxSpaces" label="Maximum number of child care spaces you offer" />
              ...
              <v-col cols="12" md="6">
                <v-text-field :disabled="isLocked" type="number" min="0" outlined required
                  :rules="[...rules.required, rules.min(0)]" v-model.number="model.maxLicensesCapacity"
                  @change="$refs.form?.validate()" label="Maximum licensed capacity" />
        ...
        <v-card class="cc-top-level-card" width="1200">
          <v-container>
            ...
            <v-row v-show="model.isExtendedHours === 'yes'">
              <v-col>
                <v-text-field :disabled="isLocked" type="number" outlined required
                  :rules="model.isExtendedHours === 'yes' ? rules.required : []"
