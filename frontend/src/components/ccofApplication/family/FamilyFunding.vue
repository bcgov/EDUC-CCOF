            ...
            <v-row>
              <v-col cols="12" md="6">
                ...
                <v-row class="padded-row">
                  <v-text-field placeholder="Required" :disabled="isLocked" outlined type="number" v-model.number="model.extendedChildCareUnder36Months4OrLess" :rules="rules.required" label="Family Child Care (under 36 months)" />
                </v-row>
                <v-row class="padded-row">
              ...
              <v-col cols="12" md="6">
                ...
                <v-row class="padded-row">
                  <v-text-field placeholder="Required" :disabled="isLocked" outlined type="number" v-model.number="model.extendedChildCareUnder36Months4OrMore" :rules="rules.required" label="Family Child Care (under 36 months)" />
                </v-row>
                <v-row class="padded-row">
                  <v-text-field placeholder="Required" :disabled="isLocked" outlined type="number" v-model.number="model.extendedChildCare36MonthsToSchoolAge4OrMore" :rules="rules.required" label="Family Child Care (36 months to School Age)" />
                </v-row>
                <v-row class="padded-row">
                  <v-text-field placeholder="Required" :disabled="isLocked" outlined type="number" v-model.number="model.extendedChildCareSchoolAge4OrMore" :rules="rules.required" label="Family Child Care (School Age/ School age care on School Grounds)" />
                </v-row>
                <v-row class="padded-row">
                  <v-text-field placeholder="Required" :disabled="isLocked" outlined type="number" v-model.number="model.multiAgeCare4more" :rules="rules.required" label="Multi-Age Care" />
                </v-row>
              </v-col>
            </v-row>
          </v-container>
