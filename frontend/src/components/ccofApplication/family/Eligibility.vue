      ...
      <v-row justify="space-around">
        <v-card class="cc-top-level-card" width="1200">
          <v-container>
            ...
            <v-row>
              <v-col>
                <v-radio-group :disabled="isLocked" row v-model="model.hasReceivedFunding" :rules="rules.required" label="Has this facility or you as the applicant ever received funding under the Child Care Operating Funding Program?">
