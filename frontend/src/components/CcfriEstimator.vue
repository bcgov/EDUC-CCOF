        ...
        >
          ...
          >
            <v-row>
              ...
              <v-col
                cols="10"
                class="pt-7 text-left"
                style="font-size: 16px; color: white; margin-left: -18px"
              >
            ...
            <div v-show="isParent || isProvider">
              ...
              <v-row>
                <v-col
                  cols="1"
                  class="pl-8 pt-0 text-right text-no-wrap"
                  style="color: white"
                >
                  1.
                </v-col>
...
"
              ...
              <v-row>
                ...
                >
                  ...
                  <div v-show="isProvider">
                    ...
                    <a
                      href="https://mychildcareservices.gov.bc.ca/login"
                      target="_blank"
              ...
              <v-row>
                ...
                <v-col
                  cols="10"
                  class="pl-8 pt-0 pb-4 text-left"
                  style="color: white"
                >
        ...
        >
          ...
          >
            ...
            <v-row>
              ...
              <v-col
                cols="1"
                style="padding-bottom: 0px; padding-top: 16px; padding-left: 0px"
              >
                <v-tooltip
                  location="top"
                  color="#68449A"
            ...
            >
              ...
              <v-row>
                <v-col
                  class="d-flex wrap justify-center"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div
                          v-for="(item, index) in getCareTypes(child.number)"
                          :key="item.type"
                        >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <v-list-item
                            :value="item.type"
                            :disabled="isScheduleDisabled(child, index)"
                          >
                            <v-list-item-title>{{ item.type }}</v-list-item-title>
                          </v-list-item>
                          <v-divider
              ...
              <v-row>
                <v-col
                  cols="8"
                  class="text-left verticalAlignFlexbox"
                >
                  <div
                ...
                >
                  <v-btn
                    style="color:white;font-family:BCSans;font-weight:600;font-family:BCSans;font-size:16px;padding-left:40px;padding-right:40px; margin-right:40px !important"
                    class="ma-2"
                    color="#0483AF"
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <template #prev>
                          <span
                            class="estimator-label fill-height pt-1 pr-7"
                            align="right"
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <v-col
                                align="center"
                                style="padding-top: 3px; padding-bottom: 5px; margin-top: -2px"
                              >
                                <span
                                  style="
                                    font-family:
              ...
              <v-row>
                ...
                >
                  <div style="color: #7b7c7e; font-family: BCSans; font-weight: 600; font-size: 16px">
                    <span
                      v-if="child.careSchedule == 'Full Time'"
                      style="color: #313131"
                    >
            ...
            <div v-show="showEstimatorResults">
                ...
                <v-col cols="10">
                  ...
                  >
                    <v-row class="mx-0">
                      ...
                      >
                        <v-card-title class="results-label pt-2 pb-2 pl-9 fill-height">
                          Child
                        </v-card-title>
                      </v-col>
                      <v-col
              ...
              <v-row>
                ...
                <v-col
                  ...
                  class="pb-4"
                >
                  <span>Families earning up to $111,000 may be eligible for the
                    <a
                      href="https://www.myfamilyservices.gov.bc.ca/s/estimator"
                      target="_blank"
                      style="color: #0fc3ed"
                    ><u>Affordable Child Care Benefit (ACCB)</u></a>.</span>
                </v-col>
                <v-col cols="1" />
              </v-row>
            </div>
    ...
    estimateTheBenefit() { ///NOSONAR
      if (this.$refs.form.validate()) {
        ...
        for (let i = 0; i < this.children.length; i++) {
          ...
          const dailyParentRate = this.children[i].parentFeeFrequency === 'Daily' ? parentRate : (parentRate / NUMBER_OF_DAYS_PER_MONTH);
          ...
          if (isPreschool) { // For preschool no need to subtract by full time daily rate as it's only part time
            reductionAmountPerChildPerDay = (dailyParentRate - 7 > rateTableInfo.partTimeDailyRate) ? rateTableInfo.partTimeDailyRate : (dailyParentRate - 7);
          ...
          let halfDayReductionAmountPerMonth = reductionAmountPerChildPerDay * partTimeNumberOfDays / (isPreschool? 1 : 2);
          ...
          let monthlyParentFee = this.getPartTimeMonthlyParentFee(this.children[i].partTimeFee ? this.children[i].partTimeFee: this.children[i].approvedFee, this.children[i].parentFeeFrequency, daysOfCare);
          ...
          if (totalMonthlyRateReduction <= rateReductionFloor) {
            ...
            let changeRateBy = Math.min(totalMonthlyRateReduction - rateReductionFloor, parentFeeFloor - (monthlyParentFee - totalMonthlyRateReduction));
