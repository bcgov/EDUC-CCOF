  ...
  <div class="outer-box">
    <div class="box-container">
      <v-row class="mb-2">
        <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
          <strong class="font-weight-bold mr-2">Licence Number:</strong>
      ...
      <v-row class="mb-2">
        <v-col cols="12" md="4" class="d-flex flex-wrap align-center">
          <strong class="font-weight-bold mr-2">Licence Effective Date:</strong>
          <span>{{ formatUTCDate(licence.licenceStartDate) }}</span>
        </v-col>
        <v-col cols="12" md="4" class="d-flex flex-wrap align-center">
          <strong class="font-weight-bold mr-2">Record Start Date:</strong>
          <span>{{ licence.recordStartDate }}</span>
        </v-col>
        <v-col cols="12" md="4" class="d-flex flex-wrap align-center">
          <strong class="font-weight-bold mr-2">Record End Date:</strong>
    ...
    <div v-if="licence?.serviceDeliveryDetails?.length">
      <div class="box-container">
        <v-row class="mb-2">
          <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
            <strong class="font-weight-bold mr-2">Maximum Capacity:</strong>
        ...
        <v-row v-for="(serviceDetail, index) in licence.serviceDeliveryDetails" :key="index" class="mb-2">
          <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
            <strong class="font-weight-bold mr-2">Licence Category:</strong>
            <span>{{ capitalize(serviceDetail.licenceCategory) }}</span>
          </v-col>
          <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
            <strong class="font-weight-bold mr-2">Maximum Capacity by Care Type:</strong>
      ...
      <div class="box-container">
        <v-row class="mb-2">
          <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
            <strong class="font-weight-bold mr-2">Max number of days per week you provide child care:</strong>
            <span>{{ licence.licenceMaxDaysPerWeek ?? EMPTY_PLACEHOLDER }}</span>
          </v-col>
          <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
            <strong class="font-weight-bold mr-2">Max number of weeks per year you provide child care:</strong>
            <span>{{ licence.licenceMaxWeeksPerYear ?? EMPTY_PLACEHOLDER }}</span>
          </v-col>
        </v-row>
        <v-row v-if="Object.keys(preschoolDetail).length" class="mb-2">
          <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
            <strong class="font-weight-bold mr-2">Number of preschool sessions per week:</strong>
        ...
        <template v-if="Object.keys(schoolAgeCareDetail).length">
          <v-row class="mb-2">
            <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
              <strong class="font-weight-bold mr-2">Before school care offered:</strong>
              <span>{{ getYesNoValue(schoolAgeCareDetail.beforeSchoolCare) }}</span>
            </v-col>
            <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
              <strong class="font-weight-bold mr-2">After school care offered:</strong>
              <span>{{ getYesNoValue(schoolAgeCareDetail.afterSchoolCare) }}</span>
            </v-col>
          </v-row>
          <v-row class="mb-2">
            <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
              <strong class="font-weight-bold mr-2">Before Kindergarten care offered:</strong>
              <span>{{ getYesNoValue(schoolAgeCareDetail.morningKinderCare) }}</span>
            </v-col>
            <v-col cols="12" md="6" class="d-flex flex-wrap align-center">
              <strong class="font-weight-bold mr-2">After Kindergarten care offered:</strong>
      ...
      <div class="box-container">
        <v-row class="mb-2">
          <v-col cols="12" class="d-flex flex-wrap align-center">
            <strong class="font-weight-bold mr-2">
