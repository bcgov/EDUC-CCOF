...
public class TestPCFRenewalApplication extends BaseTest {

	private static final Logger logger = LogManager.getLogger(TestPCFRenewalApplication.class);
	String contactName;

	@Test(priority = 1)
	public void unlockPCFRenewalApplication(Method method) throws Throwable {
		ExtentTestManager.startTest(method.getName(), "TestPCFRenewalApplication");
		logger.info("Starting the TestPCFRenewalApplication test...");
