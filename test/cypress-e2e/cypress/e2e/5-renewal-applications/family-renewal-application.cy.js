...
describe('Family Renewal Application Test', () => {
    it('Should run through Family Renewal Application, submit and logout', () => {
        ...
        cy.licenceUpload()
        cy.runCcfriApp(APP_TYPE.FAMILY_RENEWAL, PROGRAM_YEAR.FUTURE)
        cy.runEceWeApp(APP_TYPE.FAMILY_RENEWAL, PROGRAM_YEAR.FUTURE)
        submitApp.summaryAndDeclaration(APP_TYPE.FAMILY_RENEWAL)
