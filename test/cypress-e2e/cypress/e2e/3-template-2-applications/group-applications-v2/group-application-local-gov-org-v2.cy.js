...
describe("Group Application Test - Local Government", () => {
  it("Should run through Group Application for Local Government org type, submit and logout", () => {
    ...
    cy.then(() => {
      cy.runCcofApp(APP_TYPE.GROUP_V2, "Local Government");
