...
describe("Group Application Test - First Nations Government", () => {
  it("Should run through Group Application for First Nations Government org type, submit and logout", () => {
    ...
    cy.then(() => {
      cy.runCcofApp(APP_TYPE.GROUP_V2, "First Nations Government");
