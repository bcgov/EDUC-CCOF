...
describe("Group Application Test - Sole Proprietorship", () => {
  it("Should run through Group Application for Sole Proprietorship org type, submit and logout", () => {
    ...
    cy.then(() => {
      cy.runCcofApp(APP_TYPE.GROUP_V2, "Sole Proprietorship");
