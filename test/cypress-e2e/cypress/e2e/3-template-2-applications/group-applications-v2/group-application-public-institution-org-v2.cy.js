...
describe("Group Application Test - Public Institution", () => {
  it("Should run through Group Application for Public Institution org type, submit and logout", () => {
    ...
    cy.then(() => {
      cy.runCcofApp(
        APP_TYPE.GROUP_V2,
        "Public Institution (college/university)",
      );
