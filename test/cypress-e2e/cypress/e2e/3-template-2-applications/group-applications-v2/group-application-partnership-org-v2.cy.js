...
describe("Group Application Test - Partnership", () => {
  it("Should run through Group Application for Partnership org type, submit and logout", () => {
    ...
    cy.then(() => {
      cy.runCcofApp(APP_TYPE.GROUP_V2, "Partnership");
