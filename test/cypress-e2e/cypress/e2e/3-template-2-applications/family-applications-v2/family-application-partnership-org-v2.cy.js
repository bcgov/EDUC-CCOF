...
describe("Family Application Test - Partnership", () => {
  it("Should run through Family Application for Partnership org type, submit and logout", () => {
    ...
    cy.then(() => {
      cy.runCcofApp(APP_TYPE.FAMILY_V2, "Partnership");
