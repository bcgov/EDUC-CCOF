...
async function getLicences(req, res) {
  try {
    const operation =
      ...
      `&$filter=(_ccof_facility_value eq ${req.query.facilityId} and statuscode ne 100000001)`;
